...
% Making of circuit diagram. (Figure 1.1)
%
\begin{comment}
\begin{figure}
    \centering
    \begin{picture}(200,100)
    \put(-120,25){\includegraphics[width=0.95\textwidth, height=1.1in]{figures/system/circuit.png}}
    \put(-135,60){\Large{$\dotsb$}}
    \put(92,60){\Large{$\dotsb$}}
    \put(320,60){\Large{$\dotsb$}}
    \put(-32,20){\large{$n=1$}}
    \put(202,20){\large{$n=2$}}
    \put(-32,100){$\Phi_{J,n=1}$}
    \put(-68,100){$\Phi_i^l$}
    \put(-118,100){$\Phi_{i-1}$}
    \put(25,100){$\Phi_i^r$}
    \put(68,100){$\Phi_{i+1}$}
    \put(120,100){$\Phi_{j-1}$}
    \put(168,100){$\Phi_j^l$}
    \put(202,100){$\Phi_{J,n=2}$}
    \put(261,100){$\Phi_j^r$}
    \put(300,100){$\Phi_{j+1}$}
    \put(-57,75){\small{$E_{J,n=1}$}}
    \put(177,75){\small{$E_{J,n=2}$}}
    \end{picture}

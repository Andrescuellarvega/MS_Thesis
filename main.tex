...
\documentclass[masters,final, nodedication]{UTRGVthesis}
...
\input{chapters/system_draft.tex}
...
%\appendix
%\input{chapters/appendices/appendix_bloch}
%\chapter{Mathematica file for Kronig-Penney Model}\label{ch:Mathematica_KP}
%\includepdf[pages=-]{chapters/appendices/Kronig_Penney_model_transfer_matrix.pdf}
%\input{chapters/appendices/KP_Mathematica/Kronig_Penney_model_transfer_matrix}
